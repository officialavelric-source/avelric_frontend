/* Short list — homepage FAQ section */
...
/* Full topic-grouped list — /faq page */
export const FAQ_GROUPS = [
  {
    id: "orders",
    topic: "Orders",
    items: [
      { q: "Do I need an account to order?", a: "No — checkout works as a guest. An account just makes tracking, exchanges, and re-ordering faster, and saves your addresses." },
      { q: "Can I change or cancel an order after placing it?", a: "Yes, until it's handed to the courier — usually within 24 hours of ordering. Email officialavelric@gmail.com with your order number and we'll change the size, address, or cancel it entirely." },
      { q: "How do I track my order?", a: "Every order ships with tracking. All order updates, confirmation, and tracking links are sent exclusively to your registered email the moment your order is packed and dispatched." },
    ],
  },
  {
    id: "shipping",
  ...
  },
  {
    ...
    items: [
      { q: "What if the size doesn't fit?", a: "Request an exchange or return within 7 days of delivery — email us at officialavelric@gmail.com or use the contact page. Items need tags on and no wear beyond trying. Size exchanges are free; we pick the piece up." },
      { q: "How fast are refunds?", a: "Refunds reach your account within 5–7 working days of the pickup. COD refunds go to your UPI or bank account — we'll ask for details once." },
      { q: "What condition does a return need to be in?", a: "Tags on, unworn beyond trying it for fit, and in the original packaging if you still have it. We re-inspect every return the same way we inspect new stock." },
    ],
  },
  {
    id: "payments",
  ...
  {
    id: "account",
    topic: "Account & Sizing",
    items: [
      { q: "How do I know my size?", a: "Every product page lists garment measurements. Check our size guide: shirts come in M, L, XL only and jeans in 30, 32, 34 only. Still unsure? Email officialavelric@gmail.com with your measurements — we answer within a few hours." },
      { q: "Are the products branded?", a: "They come from trusted manufacturers and export-surplus lines. We don't sell counterfeits of any label — we sell quality pieces under honest names, checked and stood behind by AVELRIC." },
      { q: "If you don't make the clothes, what am I paying you for?", a: "For the search. We visit suppliers, compare fabric, stitching, and fit across hundreds of pieces, and list only what passes. You pay for a wardrobe already filtered by someone who checked it in person — plus a second quality check before dispatch." },
    ],
  },
